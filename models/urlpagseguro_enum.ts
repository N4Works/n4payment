...
export class EnumURLPagSeguro {
    ...
    static transaction_development: string = "https://ws.sandbox.pagseguro.uol.com.br/v3/transactions/notifications";
    static transaction_production: string = "https://ws.pagseguro.uol.com.br/v3/transactions/notifications";
}
